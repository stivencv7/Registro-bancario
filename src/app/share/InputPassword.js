...
export const InputPassword = ({className,value,onChange,name,placeholder,onBlur,required,disabled}) => {
    ...
    return (
        <div className='relative'>
            ...
            {type == 'text' ?
                <FaEyeSlash className='z-50 absolute left-0 bottom-0 mb-2 text-[#000035] text-[24px] pl-1 mr-50' onClick={handleType} />
                :
                <FaEye className='z-50 absolute left-0 bottom-0 mb-2 text-[#000035] text-[24px] pl-1 mr-50 ' onClick={handleType} />
            }
        </div>
    )
}
